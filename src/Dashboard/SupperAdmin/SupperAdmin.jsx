...
import AcAndFc from "./AmountAdmin/AcAndFc"; // This component will contain the chart
...
export default function SuperAdmin() {
  ...
  const handleViewChartData = () => {
    alert("Functionality to show the underlying chart data (e.g., in a table or modal) will go here!");
          ...
          <div className="bg-white p-6 rounded-xl shadow-2xl border-t-4 border-[#640037]">
            ...
            <div className="mt-4 flex justify-end">
                <button
                    ...
                    className="flex items-center space-x-1 px-3 py-1 text-sm text-[#640037] border border-pink-300 rounded-md hover:bg-pink-50 transition duration-150"
