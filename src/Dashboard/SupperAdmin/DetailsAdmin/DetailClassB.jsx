...
export default function DetailClassB({ setIsDetailsClassB }) {
  ...
  const mockClassBProducts = [
    ...
    {
      id: "B205",
      name: "ผ้าขนหนูไมโครไฟเบอร์ (แพ็ค 3)",
      code: "T550",
      volumeShare: 8.8,
      valueShare: 6.2,
      inventoryDays: 50,
  ...
  const filteredProducts = mockClassBProducts.filter(
    (product) =>
