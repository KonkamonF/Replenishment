...
export default function DetailClassA({ setIsDetailsClassA }) {
  ...
  const mockClassAProducts = [
    { id: "A101", name: "ชุดบำรุงผิวพรีเมียม", code: "CP01", volumeShare: 8.5, valueShare: 15.2, inventoryDays: 30 },
    { id: "A102", name: "เครื่องดื่มชูกำลังรสใหม่", code: "DR25", volumeShare: 7.1, valueShare: 5.8, inventoryDays: 15 },
    { id: "A103", name: "แท็บเล็ตมัลติฟังก์ชัน", code: "E080", volumeShare: 3.2, valueShare: 10.5, inventoryDays: 45 },
    { id: "A104", name: "ผงซักฟอกสูตรยับยั้งแบคทีเรีย", code: "H305", volumeShare: 9.8, valueShare: 7.1, inventoryDays: 20 },
    { id: "A105", name: "กาแฟแคปซูลสำหรับเครื่องรุ่นล่าสุด", code: "F701", volumeShare: 4.0, valueShare: 6.5, inventoryDays: 28 },
  ];
  ...
  const filteredProducts = mockClassAProducts.filter(product =>
      ...
      <div className="bg-white w-full lg:w-3/5 xl:w-1/2 h-full overflow-y-auto p-6 shadow-2xl z-50 transform transition-transform duration-300 ease-out translate-x-0">
        ...
        <div className="flex justify-between items-start mb-6 border-b pb-4">
            <h1 className="text-3xl font-extrabold text-[#640037]">
                สินค้า Class A
                <p className="text-base font-normal text-gray-500 mt-1">สินค้าที่มีความสำคัญสูงต่อยอดขายและมูลค่ารวม</p>
            </h1>
            <button
          ...
          <table className="min-w-full table-auto border-collapse border border-gray-200">
            <thead className="bg-[#640037] text-white">
              <tr>
                ...
                <th className="p-3 text-right border-r border-pink-700 w-[120px]">สัดส่วนปริมาณขาย</th>
